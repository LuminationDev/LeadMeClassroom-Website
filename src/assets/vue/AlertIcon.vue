...
<template>
  <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M9 6.00195V9.00195" :stroke="colour" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    <path d="M9 11.998H9.00833" :stroke="colour" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  </svg>
</template>