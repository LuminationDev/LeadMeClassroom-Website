...
<template>
  <div :class="{
    ...
    <label for="test" class="text-sm" :class="{
          ...
          'ml-2.5': controls,
          'text-gray-400': webFollower.disconnected,
          'text-black': !webFollower.disconnected
        }">

      <span v-if="webFollower.offTask" class="has-tooltip">
    ...
    <div v-if="controls && !webFollower.disconnected" class="mr-2">
